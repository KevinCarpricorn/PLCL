...
parser.add_argument('--dataset', default='cifar10', type=str,
                    choices=['cifar10', 'cifar100', 'cub200', 'MNIST_SPLIT', "MNIST"],
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cifar10':
        train_loader, train_givenY, train_sampler, test_loader = load_cifar10(partial_rate=args.partial_rate,
